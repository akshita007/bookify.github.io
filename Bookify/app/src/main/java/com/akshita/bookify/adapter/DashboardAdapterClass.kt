...
class DashboardAdapterClass(val context:Context, private val bookList: ArrayList<VolInfo>):RecyclerView.Adapter<DashboardAdapterClass.DashboardViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DashboardViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.single_dashboard_row, parent, false)
    ...
    override fun onBindViewHolder(holder: DashboardViewHolder, position: Int) {
        ...
        if (book.authors.length() == 1) {
            holder.txtAuthorName.text = book.authors.getString(0)
        } else {
            holder.txtAuthorName.text = book.authors.getString(0) + ", " + book.authors.getString(1)
        }
        holder.txtCategory.text = "Tag: " + book.categories.getString(0)
        ...
        holder.llcontent.setOnClickListener {
            ...
            intent.putExtra("book_author",Gson().toJson(book.authors.getString(0)))
            intent.putExtra("book_publisher",book.publisher)
            intent.putExtra("book_pages",book.pageCount)
            intent.putExtra("book_category",book.categories.getString(0))
        ...
        val author= Gson().toJson(book.authors)
